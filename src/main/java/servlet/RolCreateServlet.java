 ...
 * @author Lucy
 */
@WebServlet(name = "RolCreateServlet", urlPatterns = {"/RolCreateServlet"})
public class RolCreateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        mi_rol.setUniqueId(String.valueOf(java.util.UUID.randomUUID()));
        mi_rol.setDescripcion(request.getParameter("addDescripcion"));
        mi_rol.setEstado("ACTIVO");

        jpa_roles.create(mi_rol);
