...
public class DistritoDestroyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DistritosJpaController jpaObject = new DistritosJpaController(emf);
            Distritos objetoArchivado;

            objetoArchivado = jpaObject.findDistritos(Long.valueOf(request.getParameter("destroyId")));
